https://doi.org/10.5281/zenodo.21737432
# AgroCyberShield
...
1. Training on the aligned TON_IoT and IoT-23 training sets and testing on each domain separately
2. Training and testing within TON_IoT
3. Training and testing within IoT-23
4. Training on TON_IoT and testing on IoT-23
5. Training on IoT-23 and testing on TON_IoT
6. Optional CIC-IDS2017 external-generalisation testing
...
```text
https://github.com/bonagiriraju/AgroCyberShield
```
